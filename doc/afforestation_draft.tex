...
\add[TL]{Lastly, the tree cover changes in each model may not fully capture actual dynamics that may limit the expansion.
...
Also, no models have mechanisms for seed dispersal to limit forest expansion, or seedling planting on managed lands.
}
