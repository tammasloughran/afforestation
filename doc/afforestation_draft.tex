...
CanESM5       & No   & No  & No  & No & No & 9        & 7       & 2.8×2.8°  & \citeA{swart_canadian_2019}     \\
...
\begin{figure}
    ...
    \caption{a) Global sum tree cover area (or global mean area fraction for the right axis) over the period 2015 to 2100 in the forestation scenario (solid) and reference simulation (dashed) for each model. b-g) 2100 maps of tree cover fraction difference between the simulations for each model. MIROC-ES2L data for tree fraction are not available.}
...
\begin{figure}
    ...
    \caption{Correlation of ensemble mean 2 m surface air temperature (\textit{esm-ssp585-ssp126Lu} - \textit{esm-ssp585}) with the difference in tree cover fraction in ACCESS-ESM1-5. Only statistically significant correlations at the 5\% level are shown.}
