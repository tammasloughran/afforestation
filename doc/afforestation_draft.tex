...
They find that a decrease in 85 ppm (215 Pg(C)) of atmospheric CO$_2$ concentrations by 2100 from forrestation results in a cooling of 0.27 K globally. \footnote{Maybe mention Sonntag et al 2018 here as well?}

Historically, there has been substantial deforestation in temperate forests of Eurasia and North America and in the last few decades deforrestation has been foccused on the tropics (\cite{goldewijk_estimating_2001}).
...
However, the effect of future afforestation mat not necessarity be merely the inverse of the effect of future deforrestation.
...
\begin{figure}[H]
    ...
    \caption{Tree cover area change between 2015 to 2100 in the forestation scenario for each model.}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.45\linewidth}
        \includegraphics[width=\linewidth]{../plots/tree_area_ssp126_all_models.png}
    \end{subfigure}
    \begin{subfigure}[b]{0.45\linewidth}
