...
Forestation is a major component of future long-term emissions reduction and CO$_2$ removal strategies, but little is known about the viability of cabon stored in vegetation under future climates.
...
%    \end{tabular}
%    \caption{C pools expressed as a percentage of the present day carbon content or  as a percentage of the end of \textit{esm-ssp585}. This inormation can mostly be seen in Fig. 4 and is only presented here to show the options on how to present the data. Will likely be removed in favour of quoting in text.}
...
\begin{figure}[H]
    ...
    \end{subfigure}
    \caption{Temporal anomaly in area of trees, grass and crop between 2015 and 2100 for esm-ssp585 in ACCESS-ESM1.5}
