...
%    \end{tabular}
%    \caption{C pools expressed as a percentage of the present day carbon content or  as a percentage of the end of \textit{esm-ssp585}. This information can mostly be seen in Figure 4 and is only presented here to show the options on how to present the data. Will likely be removed in favor of quoting in text.}
...
%        \includegraphics[width=\linewidth]{../plots/tree_frac_map_2015-2100_diff.png}
%    \end{subfigure}
    \includegraphics[width=\linewidth]{../plots/tree_cover_all_models.png}
...
%    \end{subfigure}
    \includegraphics[width=\linewidth]{../plots/ACCESS_cover_fractions.png}
...
%    \end{subfigure}
    \includegraphics[width=\linewidth]{../plots/ACCESS_global_areas.png}
...
%    \end{subfigure}
    \includegraphics[width=\linewidth]{../plots/Absolute_values.png}
...
%    \end{subfigure}
    \includegraphics[width=\linewidth]{../plots/ACCESS_carbon_pools_esm-ssp585-ssp126Lu_anomalies.png}
