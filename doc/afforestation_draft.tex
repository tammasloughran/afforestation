...
\begin{itemize}
    \item Impacts of global scale forestation are still poorly understood.
...
\subsection{Changes to the Global Carbon Cycle}
...
\subsection{Regional/local changes in vegetation and extremes}
