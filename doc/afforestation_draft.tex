...
We analyze the results from seven CMIP6 models for a combined scenario with high fossil fuel emissions (from SSP5-8.5) and \remove[TL]{moderate }forest expansion (from SSP1-2.6\add[TL]{ which has $\sim$1\% forest cover increase on average across the globe}).
...
The forestation scenario analyzed here is the Land Use Model Intercomparison Project's \textit{esm-ssp585-ssp126Lu}, spanning the years 2015--2100 \cite{lawrence_land_2016} \add[TL]{ and has $\sim$1\% increase in forest cover on average}.
