...
Forestation is a major component of future long-term emissions reduction and CO$_2$ removal strategies, but little is known about the viability of carbon stored in vegetation under future climates.
...
This is the first intercomparison of the potential of forestation in emissions-driven, fully coupled earth system models, which includes a fully interactive carbon cycle and climate feedbacks.
...
So far, a multi-model intercomparison of the potential of forestation to remove CO2 and mitigate climate change under a realistic scenario is absent from the literature.
...
The Amazon grid-point features changes in mostly C4 grass to Evergreen broadleaf forest, representing an increase in tree cover fraction of 60\%.
...
Of the two models that do show significant impact of forestation on global temperature, they disagree on sign.
...
There are some increases in local scale warm extremes.
...
Forestation also provides additional co-benefits such as increased habitat, biodiversity and decreased runoff and soil erosion.
