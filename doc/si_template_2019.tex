...
\title{Supporting Information for ``Limited mitigation potential of forestation under a high emissions scenario: multi-model and single model ensembles"}
%
...
\authors{Tammas F. Loughran, Josep G. Canadell, Tomohiro Hajima, Akihiko Ito, Rachel Law, David M. Lawrence, Spencer Liddicoat, Julia Pongratz, Tilo Ziehn}

\affiliation{1}{CSIRO Environment, Aspendale, Victoria, Australia}
\affiliation{2}{CSIRO Environment, Canberra, ACT, Australia}
\affiliation{3}{Research Institute for Global Change, Japan Agency for Marine-Earth Science and Technology, Kanagawa, Japan}
\affiliation{4}{National Institute for Environmental Studies, Onogawa, Tsukuba, Japan}
\affiliation{5}{Climate and Global Dynamics Laboratory, National Center for Atmospheric Research, Boulder, CO, USA}
\affiliation{6}{Met Office Hadley Centre, Exeter, UK}
\affiliation{7}{Ludwig-Maximilians-Universität München, Luisenstr. 37, 80333 Munich, Germany}
...
\begin{figure}
    \includegraphics[width=\linewidth]{tree_fraction_ssp126_all_models_globalmean.png}
