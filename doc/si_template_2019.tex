...
\documentclass[draft,gbc]{agutexSI2019}
...
\title{Supporting Information for ``Limited mitigation potential of forestation under a high emissions scenario: results from multi-model and single model ensembles"}
%
...
\begin{figure}
    ...
    \caption{LUH2 primary and secondary forest cover fractions difference between SSP1-2.6 and SSP5-8.5 at 2100.}
    \label{fig:LUH2DIFF}
\end{figure}

\begin{figure}
    \includegraphics[width=\linewidth]{tree_cover_all_models.png}
...
\begin{figure}
    \includegraphics[width=\linewidth]{ACCESS_cover_fractions.png}
...
\begin{figure}
    \includegraphics[width=\linewidth]{ACCESS_global_areas.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{models_co2.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{significant_ensemble_members.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{tas_maps_models.png}
...
\begin{figure}
    \includegraphics[width=\linewidth]{Absolute_values.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\linewidth]{pr_trends.png}
...
\begin{figure}
    \includegraphics[width=\linewidth]{ACCESS_carbon_pools_esm-ssp585-ssp126Lu_anomalies.png}
