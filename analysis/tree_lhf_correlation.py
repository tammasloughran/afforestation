...
def make_ens_mean_first_correlation():
    ...
    if not load_npy_files:
        ...
        ncfile = nc.Dataset('/g/data/p66/rml599/ESM-ensemble/esm-ssp585/hfls_Amon_ACCESS-ESM1-5_esm-ssp585_ens_gn_201501-210012.ann.nc', 'r')
        albedo_ssp585 = ncfile.variables['hfls'][:]
        ncfile = nc.Dataset('/g/data/p66/rml599/ESM-ensemble/esm-ssp585-ssp126Lu/hfls_Amon_ACCESS-ESM1-5_esm-ssp585-ssp126Lu_ens_gn_201501-210012.ann.nc', 'r')
        albedo_for = ncfile.variables['hfls'][:]
        ncfile.close()
    ...
    plt.title('Correlation between latent heat flux and tree fraction')
    plt.tight_layout()
    plt.savefig(f'{PLOTS_DIR}/correlation_tree_hfls_ens_mean_first.png', dpi=DPI)
    ...
    plt.tight_layout()
    plt.savefig(f'{PLOTS_DIR}/correlation_tree_hfls_significance_ens_mean_first.png', dpi=DPI)
    plt.show()
