...
def make_ens_mean_first_correlation():
    ...
    if not load_npy_files:
        ...
        ncfile = nc.Dataset('/g/data/p66/rml599/ESM-ensemble/esm-ssp585/albedo-maybe-esm-ssp585.nc', 'r')
        albedo_ssp585 = ncfile.variables['rsuscs'][:]
        ncfile = nc.Dataset('/g/data/p66/rml599/ESM-ensemble/esm-ssp585-ssp126Lu/albedo-maybe-esm-ssp585-ssp126Lu.nc', 'r')
        albedo_for = ncfile.variables['rsuscs'][:]
        ncfile.close()
    ...
    plt.title('Correlation between albedo and tree fraction')
    plt.tight_layout()
    plt.savefig(f'{PLOTS_DIR}/correlation_tree_albedo_ens_mean_first.png', dpi=DPI)
    ...
    plt.tight_layout()
    plt.savefig(f'{PLOTS_DIR}/correlation_tree_albedo_significance_ens_mean_first.png', dpi=DPI)
    plt.show()
