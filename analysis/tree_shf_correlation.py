...
def make_ens_mean_first_correlation():
    ...
    if not load_npy_files:
        ...
        ncfile = nc.Dataset('/g/data/p66/rml599/ESM-ensemble/esm-ssp585/hfss_Amon_ACCESS-ESM1-5_esm-ssp585_ens_gn_201501-210012.ann.nc', 'r')
        albedo_ssp585 = ncfile.variables['hfss'][:]
        ncfile = nc.Dataset('/g/data/p66/rml599/ESM-ensemble/esm-ssp585-ssp126Lu/hfss_Amon_ACCESS-ESM1-5_esm-ssp585-ssp126Lu_ens_gn_201501-210012.ann.nc', 'r')
        albedo_for = ncfile.variables['hfss'][:]
        ncfile.close()
    ...
    plt.title('Correlation between sensible heat flux and tree fraction')
    plt.tight_layout()
    plt.savefig(f'{PLOTS_DIR}/correlation_tree_hfss_ens_mean_first.png', dpi=DPI)
    ...
    plt.tight_layout()
    plt.savefig(f'{PLOTS_DIR}/correlation_tree_hfss_significance_ens_mean_first.png', dpi=DPI)
    plt.show()
